...
class Visitors extends Controller {
	...
	public function getVisitorsAndPageViewsData($days = 7)
	{
	...
	public function getExtrasData($days = 7)
	{
		...
		$totals_before = LaravelAnalytics::performQuery(Carbon::now()->subDays($days*2), Carbon::now()->subDays($days*2), 'ga:sessions,ga:pageviews');
	...
	public function getRegistrationsData($days = 7)
	{
		...
		$stats = \Platform\Users\Models\User::select(array(
